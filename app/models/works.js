...
exports.Work = function (collectionName) {
  ...
  //Esquema de work
  let Work = DB.model(collectionName, new mongoose.Schema({
    // CLIENT
...
exports.Group = function (collectionName) {
  ...
  let Group = DB.model(collectionName, new mongoose.Schema({
    text : { type: String, unique: true },
    src : String,
    created : { type: Date, default: Date.now },
    bucket : String,
...
exports.Tags = function (collectionName) {
  ...
  let Tags = DB.model(collectionName, new mongoose.Schema({
    text : { type: String, unique: true },
    created : { type: Date, default: Date.now }
  }))
